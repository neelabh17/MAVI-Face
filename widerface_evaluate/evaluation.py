...
if __name__ == '__main__':
    ...
    for i in ious:
        # print(i)
        # input()
        iouVsAP.append([i,evaluation(args.pred,args.gt,i)])
    summer=[0 for i in range(3)]
    s=0
    a=open("widerEval.txt", "w")

    while(s<3):
        print("For level "+str(s)+ " the results are")
        a.write("For level "+str(s)+ " the results are\n")
        for itemer in iouVsAP:

            print(str(itemer[0])+" -------->"+str(itemer[1][s]))
            a.write(str(itemer[0])+" -------->"+str(itemer[1][s])+"\n")
            summer[s]+=itemer[1][s]

            print("=================================================")
            a.write("=================================================\n")
    
        print("mAP is : " +str(summer[s]/10))
        a.write("mAP is : " +str(summer[s]/10)+"\n\n")
        s+=1
