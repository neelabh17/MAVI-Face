...
if __name__ == '__main__':
    ...
    for i, img_name in enumerate(neelTestDataset):
        ...
        #new version
        save_name = args.save_folder+args.trained_model.strip(".pth").strip("/weights/")+"/" + img_name[:-4] + ".txt"
    ...
    a=open("./widerface_evaluate/lastModelRun.txt","w")
    a.write(args.trained_model[10:-4])
    a.close()
